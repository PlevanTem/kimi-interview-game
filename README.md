...
- 第0幕完成盐蚀木筏、绳结、断桨、湿岸和导星试点；整圈可见湿岸均可触发“试水温”E反馈。
- Esc航程面板始终显示八幕对应名称，未经历的核心记忆仍保持隐藏。
...
当前81项单测通过。前一轮第0—2幕交付另有开场、两幕交互/离岛和资源稳定性的浏览器用例；本轮补充八幕暂停进度与异地湿岸E反馈回归。完整八幕流程有 `@journey` 用例，但**未在最近这轮美术迭代中重跑**。软件渲染下的资源稳定性不等于显卡性能达标。
